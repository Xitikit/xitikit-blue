...
import static org.xitikit.blue.b2c.v2dot0.authentication.PolicyErrorCodes.*;
...
public class SimpleB2CAuthenticationController implements B2CAuthenticationController{
    ...
    @Autowired
    public SimpleB2CAuthenticationController(final B2CAuthenticationService blueKitB2CAuthenticationService, final B2cPolicyUrlService urlService){
    ...
    @Override
    public String authenticatePost(final String idToken, final String errorDescription, final String error){

        return authenticatePost(idToken, errorDescription, error, this.authSuccessRedirect, this.authFailureRedirect);
    }

    @Override
    public String authenticatePost(
