...
public final class VerificationUtil{
    ...
    public static boolean validateIssuer(final BlueWebToken token){
        ...
        Assert.notNull(token, "Missing required parameter 'token' (org.xitikit.bluekit.b2c.v2dot0.authentication.VerificationUtil::validateIssuer)");
    ...
    public static boolean validateExpiration(final BlueWebToken token, @Nullable final Long now){
        ...
        Assert.notNull(token, "Missing required parameter 'token' (org.xitikit.bluekit.b2c.v2dot0.authentication.VerificationUtil::validateExpiration)");
