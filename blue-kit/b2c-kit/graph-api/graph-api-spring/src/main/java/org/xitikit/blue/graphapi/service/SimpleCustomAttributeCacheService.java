 ...
 */
public class SimpleCustomAttributeCacheService implements CustomAttributeCacheService{
    ...
    public SimpleCustomAttributeCacheService(
    ...
    private ExtensionProperty getExtensionProperties(final String propertyName){
        ...
        try{
            ...
            for(Application application : applicationList){
                if(application
                    ...
                    if(extensionProperties.getValue() != null){
