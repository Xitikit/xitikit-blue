...
public class B2CServicesAutoConfiguration{
    ...
    @ConditionalOnBean(
        value = {
            ClaimValidationService.class, NonceService.class,
            UrlService.class, RestTemplate.class,
            B2CProperties.class, NonceProperties.class,
            SignUpOrSignInPolicy.class, SignUpPolicy.class,
            SignInPolicy.class, ResetPasswordPolicy.class,
            EditProfilePolicy.class, SignOutPolicy.class,
        })
