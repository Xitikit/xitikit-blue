 ...
 */
public class SimplePolicyUrlService implements PolicyUrlService{
    ...
    public String getSignUpUrl(){
        ...
        return getPolicyUrl(policyConfiguration.getSignUp());
    }
    ...
    public String getSignInUrl(){
        ...
        return getPolicyUrl(policyConfiguration.getSignIn());
    }
    ...
    public String getSignUpOrSignInUrl(){
        ...
        return getPolicyUrl(policyConfiguration.getSignUpOrSignIn());
    }
    ...
    public String getProfileUrl(){
        ...
        return getPolicyUrl(policyConfiguration.getEditProfile());
    }
    ...
    public String getResetPasswordUrl(){
        ...
        return getPolicyUrl(policyConfiguration.getResetPassword());
    }
    ...
    public String getSignOutUrl(){
        ...
        SignOutPolicy signOutPolicy = policyConfiguration.getSignOut();
