...
class B2cPolicyConfigurationFactoryTest{
    ...
    void of(){
        ...
        B2cPolicyConfiguration b2cPolicyConfiguration = factory.build();

        PolicyConfigurationFactory factory2 = PolicyConfigurationFactory.of(b2cPolicyConfiguration);

        assertFalse(factory == factory2);//checking reference, not sameness
        //noinspection ObjectEquality
        assertFalse(b2cPolicyConfiguration == factory2.build());//checking reference, not sameness
    }

    @Test
    void defaultValues(){

        B2cPolicyConfiguration target = PolicyConfigurationFactory
            .instance()
            .defaultValues()
            .build();
